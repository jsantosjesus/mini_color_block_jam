...
class ColorBlockJamGame extends FlameGame
  ...
  Future<void> onLoad() async {
    ...
    blocks = [
      BlockComponent(color: Colors.red, gridX: 0, gridY: 0),
      BlockComponent(color: Colors.red, gridX: 2, gridY: 3),
      BlockComponent(color: Colors.red, gridX: 3, gridY: 3),
      BlockComponent(color: Colors.red, gridX: 4, gridY: 3),
      BlockComponent(color: Colors.blue, gridX: 1, gridY: 3),
      BlockComponent(color: Colors.blue, gridX: 1, gridY: 1),
      BlockComponent(color: Colors.blue, gridX: 4, gridY: 4),
      BlockComponent(color: Colors.green, gridX: 2, gridY: 4),
      BlockComponent(color: Colors.green, gridX: 0, gridY: 1),
      BlockComponent(color: Colors.yellow, gridX: 4, gridY: 2),
      BlockComponent(color: Colors.yellow, gridX: 2, gridY: 2),
      BlockComponent(color: Colors.yellow, gridX: 3, gridY: 2),
      BlockComponent(color: Colors.yellow, gridX: 3, gridY: 1),
    ];
    ...
    doors = [
      DoorComponent(color: Colors.red, gridX: 0, gridY: 2), // esquerda
      DoorComponent(color: Colors.blue, gridX: 4, gridY: 1), // direita
      DoorComponent(color: Colors.green, gridX: 2, gridY: 0), // topo
      DoorComponent(color: Colors.yellow, gridX: 3, gridY: 4), // fundo
    ];
...
void onPanEnd(DragEndInfo info) {
  ...
  final snappedX = (selectedBlock!.position.x / cellSize).round().clamp(0, gridSize - 1);
  final snappedY = (selectedBlock!.position.y / cellSize).round().clamp(0, gridSize - 1);
